  ...
  return (
    <section className="mx-auto container px-4 lg:px-10 lg:py-12 xl:py-20 xl: flex lg:flex-row flex-col xl:gap-10 items-start justify-center">
      <div className="flex flex-col justify-between items-center sm:items-start sm:mb-12 py-6 gap-8 container lg:max-w-sm">
        <h2 className="font-bai-jamjuree font-semibold text-3xl md:text-4xl">Some Of My Projects</h2>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
              <div className="lg:max-w-[340px] text-center sm:text-start max-sm:border-b max-sm:pb-3">
                <h3 className="font-bai-jamjuree font-semibold text-secondary text-xl mb-2">{achievement.title}</h3>
                <p className="text-secondary-2 mb-2 text-sm font-semibold">{achievement.organization}</p>
                <p className="text-secondary-2 mb-2 text-sm font-semibold">{achievement.role}</p>
              </div>
