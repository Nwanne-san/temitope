      ...
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-8 py-12 border-t border-white/10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="font-serif text-lg mb-4 text-white">Follow Me</h3>
          ...
          >
            <div>
              <p className="text-lg font-semibold font-serif text-white">
                Work With Me
              </p>
            </div>
            <form
        ...
        >
          ...
          <Link
            href="/privacy"
            className="hover:text-white/80 sm:block hidden font-sans"
          >
            Privacy Policy
          </Link>
        </motion.div>
