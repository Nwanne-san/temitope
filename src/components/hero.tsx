  ...
  return (
    <section className="container mx-auto px-4 sm:py-12 flex pb-16 sm:pb-20 xl:pb-24 xl:px-10 flex-col-reverse lg:flex-row xl:grid grid-cols-2 items-center gap-12">
      ...
      >
        ...
        <motion.div
          className="flex flex-col sm:flex-row gap-2 pb-4 items-center text-secondary"
          variants={itemVariants}
        >
          ...
          <span className="flex items-center">
            <hr className="text-secondary bg-secondary/60 h-0.5 w-20 mt-3" />
          </span>
          <motion.div
          ...
          >
            {[
              ...
              <motion.div key={index} variants={socialVariants}>
                <Link
                  href={social.href}
                  className="text-secondary px-1 hover:scale-110 duration-300 rounded-full hover:text-primary transition-all"
                  target="_blank"
                >
                  <social.icon size={18} />
                </Link>
